...
Note: The NAPI build creates platform-specific binaries. For development, we only build for the current platform. CI will handle cross-compilation for releases.
  </action>
  <verify>
