    ...
    steps:
      ...
      - name: Summary
        run: |
          ...
          echo "- **Docker Publish:** Builds and pushes Docker image to Docker Hub (with GHCR mirror)" >> $GITHUB_STEP_SUMMARY
```
...
4. **Verify releases created:**
   ...
   - Docker Hub shows new Docker image (and GHCR mirror is updated)
